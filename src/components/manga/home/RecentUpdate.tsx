                            ...
                            <CardBody className="p-4">
                                <div className="flex gap-4">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <h3 
                                            className="text-white font-bold text-lg mb-2 cursor-pointer hover:text-[#00CCFF] transition-colors"
                                            onClick={() => {
                                                console.log('Navigate to:', item.title);
                                            }}
                                        >
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <Button 
                                                ...
                                                onClick={(e) => {
                                                    e.stopPropagation();
                                                    console.log('Continue reading:', item.title);
                                                }}
                                            >
                                                Đọc Tiếp
                                            </Button>
